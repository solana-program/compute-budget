...
pub const SET_LOADED_ACCOUNTS_DATA_SIZE_LIMIT_DISCRIMINATOR: u8 = 4;
...
impl Default for SetLoadedAccountsDataSizeLimitInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
impl SetLoadedAccountsDataSizeLimitInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
