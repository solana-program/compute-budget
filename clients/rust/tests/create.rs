...
use solana_compute_budget::{accounts::Counter, instructions::CreateBuilder};
...
#[tokio::test]
async fn create() {
    let mut context = ProgramTest::new("solana_compute_budget_program", solana_compute_budget::ID, None)
        .start_with_context()
        .await;
